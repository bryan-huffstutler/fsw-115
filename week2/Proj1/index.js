let species = {
  ...
  "results": [
      ...
      },
      {
          ...
          "url": "http://swapi.dev/api/species/8/"
      },
      {
          "name": "Ewok",
          "classification": "mammal",
          ...
          "url": "http://swapi.dev/api/species/9/"
      },
      {
          "name": "Sullustan",
          "classification": "mammal",
          ...
          "url": "http://swapi.dev/api/species/10/"
      }
  ]
}
//Saving the results array to a variable to .map() on
let specRes = species.results
//Grabbing UL from HTML
let x = document.getElementById("people")
//.map() on specRes variable to create LI's for UL
specRes.map(function (y){
    console.log(y)
    //Creating the LI
    let li = document.createElement("li")
    //To append the String version of the JSON Object to the LI
    li.append(JSON.stringify(y))
    //Appending LI to ul with id of "people"
    x.append(li)
})